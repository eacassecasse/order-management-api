...
**Example API Request:**                 [Sign Up to Run API Request](http://accounts.mansto.com/signup)

> `http://api.mansto.com/v1/endpoints/clients?`**access_key=YOUR_ACCESS_KEY**`&page=1&limit=10&sort\[\]=id,desc`
...
"description": "Could not find the resource you have searched for", 
"date&time": { 
